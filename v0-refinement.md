...
specified Saffron component.
→ Cause: v0 doesn't have native knowledge of Saffron. If the prompt
...
because v0 has no native Saffron knowledge.

```
Replace [wrong component] with the correct Saffron [SafComponentName].
