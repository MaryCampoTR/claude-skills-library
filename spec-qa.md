...
## Gate 2: Saffron Vocabulary Accuracy

### 2.1 — Component names
- [ ] Every component name matches the exact Saffron vocabulary
...
- [ ] No generic HTML element descriptions used where a Saffron
...
- [ ] Focus states rely on Saffron focus ring pattern
- [ ] Hover states consistent with Saffron interactive tokens
...
- [ ] Universal preamble present (stack, fonts, Saffron token reminders)
...
- [ ] Layout described with Saffron pattern names or explicit structure
