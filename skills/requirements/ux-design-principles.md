...
description: >
  ...
  progressive disclosure, accessibility (WCAG 2.2 AA), and Saffron-specific
...
- [ ] Saffron status colours are AA-compliant when used as specified —
...
- [ ] Focus ring always visible — Saffron focus pattern:
...
### Touch & Motor:
- [ ] Minimum touch target: 44×44px (Saffron standard density = 40px —
...
- AI follows the same interaction vocabulary as the rest of the product
  → Use Saffron components — never invent new AI-specific UI patterns
...
- **Chunked AI output:** Structure AI responses into sections with
  ...
  → Heading (Clario medium) → Key point → Supporting detail (collapsed)
...
**Design patterns:**
- All AI controls meet Saffron keyboard and focus standards (see
...
## AI Component Vocabulary (Saffron)

No new components needed — use Saffron components with intentional props:

| AI UX need | Saffron pattern |
|---|---|
